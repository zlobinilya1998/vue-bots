  ...
  <div class="page">
    <div class="page-content">
      <div class="page-content-main">
        <div class="user-welcome">
          <img
            ...
            :src="
              user.photo
                ? user.photo
                : 'http://localhost:3000/static/avatar/no-user.png'
            "
          />
          <div>
            <p class="user-welcome-title">Здравствуйте,</p>
            <p class="user-welcome-login">{{ user.login }}</p>
          </div>
        </div>
        <div
          @click="navigation('score')"
          :class="{ active: $route.name === 'score' }"
          class="page-content-main-item"
        >
          <div class="icon">
            <svg
              width="29"
        ...
        <div
                @click="navigation('administration')"
        ...
        >
          ...
          <p class="page-content-main-item-description">Администрирование</p>
        </div>
      </div>
